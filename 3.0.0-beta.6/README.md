...
If you found a bug, have a question or an idea, please check [AOS contribution guide](https://github.com/michalsnik/aos/blob/next/CONTRIBUTING.md) and don't hesitate to create new issues.